...
<?php
  ...
  $sth = $conn->prepare("SELECT id, login, password, id_form, id_superpowers FROM USERS where login=:login and password=:password");
  ...
  if(!empty($result)){
    ...
    $_SESSION['id_superpowers']=$result[0]['id_superpowers'];
